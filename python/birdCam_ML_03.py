# birdCam_ML_02.py
# updated Feb 23, 2020
# Use AlexNet CNN for bird species inference
...
output_folder = "/home/pichaya/birdCam_ML/ML03/"
model_path = '/home/pichaya/birdCam_ML/birdCam_MobileNetV2_20210305_TFTRT_FP16'
...
birdCam = birdCam_trt(model_path)
...
dataFile = output_folder+"birdCam_ml03.dat"
    ...
    while(1): 
        ...
        if birdCam.isBird(species) and not birdCam.flags[2]: # take first image
            ...
            if birdCam.numImSet()>0:
                ...
                # record data
                dataStr = "%d,%d,%.2f,%.2f\n"%(birdCam.time,species,confidence,time.time()-birdCam.time)
